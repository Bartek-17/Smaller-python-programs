...
text_result.grid(columnspan=5) #Grid(siatka)-Dzięki temu możemy zmieniać szerokość i ilość kolumn lub marginesów, można układać treść tak, by była ona czytelna dla użytkownika.
